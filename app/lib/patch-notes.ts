...
export const PATCH_NOTES: PatchNote[] = [
  ...
  },
  {
    ...
    changes: [
      ...
      "D&D reference data aligned to the 2024 SRD 5.2.1 catalog; 2014 choices are no longer offered",
      "Equipment databank refreshed with the 2024 SRD 5.2.1 equipment tables",

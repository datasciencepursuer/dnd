...
export function GroupInvitationEmail({ url, inviterName, groupName }: GroupInvitationEmailProps) {
  return (
    <Html>
      <Head />
        ...
        <Container style={styles.container}>
          ...
          <Section style={styles.content}>
            ...
            <Text style={styles.text}>
              {inviterName} has invited you to join <strong>{groupName}</strong> on bubufulplanet.
            </Text>
